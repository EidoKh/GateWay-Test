...
Route::post('login-user', [\App\Http\Controllers\Api\UserController::class, 'loginUser']);
...
Route::get('new-books', [BookController::class, 'newBooks']);
...
Route::get('like-book', [LikeController::class, 'likeBook']);
Route::get('dislike-book/{book_id}', [LikeController::class, 'dislikeBook']);
