        ...
        >
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
              ...
              >
                <div class="w-full text-right">
                  <span class="mr-2 text-sm tracking-wide truncate"
                    >الرئيسية</span
                  >
            ...
            <li>
              ...
              >
                <div class="w-full text-right">
                  <span class="mr-2 text-sm tracking-wide truncate">الكتب</span>
                  <span class="inline-flex justify-center items-center mr-4">
                    <svg
                      class="w-5 h-5"
                      fill="none"
            ...
            <li>
              ...
              >
                <div class="w-full text-right">
                  <span class="mr-2 text-sm tracking-wide truncate">الضبط</span>
                  <span class="inline-flex justify-center items-center mr-4">
                    <svg
                      class="w-5 h-5"
                      fill="none"
